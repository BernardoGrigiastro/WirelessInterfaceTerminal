...
public final class WITServerPacketHandler extends WITPacketHandlerBase implements IPacketHandler {

	private static final WITServerPacketHandler INSTANCE = new WITServerPacketHandler();

	public static final WITServerPacketHandler instance() {
		return INSTANCE;
	}
